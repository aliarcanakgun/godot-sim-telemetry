...
void ACCProvider::_flush_sessions_to_disk(std::vector<ACC_LapDataChannels> data_to_save, ACC_SPageStatic static_data_copy, double save_spm, String path) {
...
String ACCProvider::_open_session_file(const String& file_path, TelemetryFile& infile, ACC_SPageStatic& out_static, double& out_samples_per_meter, uint64_t& out_lap_count, std::vector<uint64_t>& out_lap_offsets, int64_t& out_timestamp) {
